...
namespace ProMe_Admin.Controllers
{
    ...
    public class SettingsEnemadsController : Controller
    {
        ...
        public async Task<IActionResult> Edit(int? id, CancellationToken cancellationToken)
        {
            ...
            var settingsEnemad1 = await settingsEnemadsService.GetByIdAsync(cancellationToken, id);
        ...
        public async Task<IActionResult> Delete(int? id, CancellationToken cancellationToken)
        {
            ...
            var settings = await settingsEnemadsService.GetByIdAsync(cancellationToken, id);
        ...
        {
            var customPage = await settingsEnemadsService.GetByIdAsync(cancellationToken, id);
            await settingsEnemadsService.DeleteAsync(customPage, cancellationToken);
            return RedirectToAction(nameof(Index));
        }
