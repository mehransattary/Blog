...
namespace ProMe_Admin.Controllers
{
    ...
    public class SettingsMetasController : Controller
    {
        ...
        public async Task<IActionResult> Edit(int? id, CancellationToken cancellationToken)
        {
            ...
            var settingsMeta = await settingsMetasService.GetByIdAsync(cancellationToken, id);
        ...
        public async Task<IActionResult> Delete(int? id, CancellationToken cancellationToken)
        {
            ...
            var settings = await settingsMetasService.GetByIdAsync(cancellationToken, id);
        ...
        {
            var customPage = await settingsMetasService.GetByIdAsync(cancellationToken, id);
            await settingsMetasService.DeleteAsync(customPage, cancellationToken);
            return RedirectToAction(nameof(Index));
        }
