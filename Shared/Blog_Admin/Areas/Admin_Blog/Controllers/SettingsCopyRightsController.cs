...
namespace ProMe_Admin.Controllers
{
    ...
    public class SettingsCopyRightsController : Controller
    {
        ...
        public async Task<IActionResult> Edit(int? id, CancellationToken cancellationToken)
        {
            ...
            var settingsCopyRight = await settingsCopyRightsService.GetByIdAsync(cancellationToken, id);
        ...
        public async Task<IActionResult> Delete(int? id, CancellationToken cancellationToken)
        {
            ...
            var settings = await settingsCopyRightsService.GetByIdAsync(cancellationToken, id);
        ...
        {
            var customPage = await settingsCopyRightsService.GetByIdAsync(cancellationToken, id);
            await settingsCopyRightsService.DeleteAsync(customPage, cancellationToken);
            return RedirectToAction(nameof(Index));
        }
