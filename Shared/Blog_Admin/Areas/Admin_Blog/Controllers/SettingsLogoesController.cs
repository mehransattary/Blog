...
namespace ProMe_Admin.Controllers
{
    ...
    public class SettingsLogoesController : Controller
    {
        ...
        public async Task<IActionResult> Edit(int? id, CancellationToken cancellationToken)
        {
            ...
            var settingsLogo = await settingsLogoesService.GetByIdAsync(cancellationToken, id);
        ...
        public async Task<IActionResult> Delete(int? id, CancellationToken cancellationToken)
        {
            ...
            var settings = await settingsLogoesService.GetByIdAsync(cancellationToken, id);
        ...
        {
            var customPage = await settingsLogoesService.GetByIdAsync(cancellationToken, id);
            await settingsLogoesService.DeleteAsync(customPage, cancellationToken);
            return RedirectToAction(nameof(Index));
        }
