...
namespace ProMe_Admin.Controllers
{
    ...
    public class WebLogLabelController : Controller
    {
        #region Ctor
        private readonly IWeblogLabelService WebLog_LabelService;

        private readonly UserManager<IdentityUser> userManager;
        public WebLogLabelController(IWeblogLabelService WebLog_LabelService, UserManager<IdentityUser> userManager)
        {
