...
namespace Entities
{
    public class WebLog_Category : BaseMetaTag
    {
        ...
        #endregion
        #region Relations
        public ICollection<WebLog_Group> webLog_Groups { get; set; }
        #endregion



    }
    public class Configuration_WebLog_Category : IEntityTypeConfiguration<WebLog_Category>
    {
        public void Configure(EntityTypeBuilder<WebLog_Category> builder)
        {
