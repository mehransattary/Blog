...
namespace Service.Repository.Interface
{
    public interface IWeblogGroupService : IRepository<WebLog_Group>
    {
        ...
        Task<IList<WebLog_Group>> SelectListAsync(CancellationToken cancellationToken, string UserId);
        Task<IList<WebLog_Group>> SelectListAsync(CancellationToken cancellationToken, string UserId,int groupId=0);
    }
}
