        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WeblogId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BaseView_WebLog_Labels_LabelId",
                        column: x => x.LabelId,
                        principalSchema: "dbo",
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_BaseView_Weblogs_WeblogId",
                        column: x => x.WeblogId,
                        principalSchema: "dbo",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BaseView_LabelId",
                schema: "dbo",
                table: "BaseView",
                column: "LabelId");

            migrationBuilder.CreateIndex(
                name: "IX_BaseView_WeblogId",
                schema: "dbo",
                table: "BaseView",
                column: "WeblogId");
